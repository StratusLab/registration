...
public class RegistrationApplication extends Application {
    ...
    public Restlet createInboundRoot() {
        ...
        Reference styleRef = LocalReference
                .createClapReference(LocalReference.CLAP_THREAD, appConfiguration.getValue(Parameter.STYLE_PATH));
    ...
    public ChallengeAuthenticator setupGuard(Class<? extends ServerResource> targetClass) {
        ...
        ChallengeAuthenticator guard = new ChallengeAuthenticator(null, ChallengeScheme.HTTP_BASIC, "StratusLab");
